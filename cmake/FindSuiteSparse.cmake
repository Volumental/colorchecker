# This file has been originally copied from PCL:
# https://github.com/PointCloudLibrary/pcl/blob/master/cmake/Modules/FindSuiteSparse.cmake
# However, it was tweaked to make it work on some UNIX platform. Best solution
# would be to try push this upstream to suitesparse project.
...
IF(CYGWIN OR UNIX AND NOT(APPLE))
  ...
  mark_as_advanced(FORCE COLAMD_LIBRARY CCOLAMD_LIBRARY)

  SET(CHOLMOD_LIBRARIES ${CHOLMOD_LIBRARY} ${AMD_LIBRARY} ${CAMD_LIBRARY} ${COLAMD_LIBRARY} ${CCOLAMD_LIBRARY})
...
ENDIF(CYGWIN OR UNIX AND NOT(APPLE))
